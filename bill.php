...
$sql="SELECT * FROM `audio` WHERE username='$userid'";
$result=mysqli_query($con,$sql);
$resultcheck=mysqli_num_rows($result);
  
$q1="SELECT SUM(price) as 'total' from audio";
...
if($resultcheck > 0){
  	...
  	echo"<label >Audio Name:</label>", $row['song']."<br>";
   ...
   echo "<label>Total:</label>".$data['total'];
    echo "</div><br>";
